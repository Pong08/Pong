...
class First extends StatelessWidget {
  Future<List<FirstSubmodel>> _getSubmodel() async {
    final strsql =
        ...
        " where productcode = 'E' and cancel = 'N' and showapp = 'Y'"
        " order by submodel ";
    ...
    List<FirstSubmodel> tblsubmodel = [];

    for (var u in jsonData) {
      FirstSubmodel submodel = FirstSubmodel(
          u["submodel"],u["meaning"],u["pathpicture"],u["pricea"]);

      tblsubmodel.add(submodel);
    }
    print(tblsubmodel.length);
    return tblsubmodel;
  }
...
class FirstSubmodel {
  ...
  final String pricea;
  FirstSubmodel(this.submodel,this.meaning,this.pathpicture,this.pricea);
}
