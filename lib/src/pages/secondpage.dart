...
class Second extends StatelessWidget {
  Future<List<SecondSubmodel>> _getSubmodel() async {
    final strsql =
        ...
        " where productcode = 'M' and cancel = 'N' and showapp = 'Y'"
        " order by submodel ";
    ...
    List<SecondSubmodel> tblsubmodel = [];

    for (var u in jsonData) {
      SecondSubmodel submodel = SecondSubmodel(
...
class SecondSubmodel {
  final String submodel;
  final String meaning;
  final String pathpicture;
  final String pricea;
  SecondSubmodel(this.submodel,this.meaning,this.pathpicture,this.pricea);
}