...
class Third extends StatelessWidget {
  Future<List<ThirdSubmodel>> _getSubmodel() async {
    final strsql =
        ...
        " where productcode = 'B' and cancel = 'N' and showapp = 'Y'"
        " order by submodel ";
    ...
    List<ThirdSubmodel> tblsubmodel = [];

    for (var u in jsonData) {
      ThirdSubmodel submodel = ThirdSubmodel(
...
class ThirdSubmodel {
  ...
  final String pricea;
  ThirdSubmodel(this.submodel,this.meaning,this.pathpicture,this.pricea);
}