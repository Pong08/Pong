...
class Fifth extends StatelessWidget {
  Future<List<FifthSubmodel>> _getSubmodel() async {
    final strsql =
    ...
    List<FifthSubmodel> tblsubmodel = [];

    for (var u in jsonData) {
      FifthSubmodel submodel = FifthSubmodel(
...
class FifthSubmodel {
  ...
  final String pricea;
  FifthSubmodel(this.submodel,this.meaning,this.pathpicture,this.pricea);
}
